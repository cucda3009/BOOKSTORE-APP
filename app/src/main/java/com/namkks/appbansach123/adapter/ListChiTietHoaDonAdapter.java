...
public class ListChiTietHoaDonAdapter extends RecyclerView.Adapter<ListChiTietHoaDonAdapter.ViewHolder> {
    ArrayList<ChiTietHoaDon> arrayList;
    Context context;

    public ListChiTietHoaDonAdapter(ArrayList<ChiTietHoaDon> arrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.item_ctdhSoL.setText("x"+ arrayList.get(position).getSoL());
    }
